   ...
   public class Board
    {
        ...
        public Board()
        {
            kisiListesi.Add(0, "Samet Akca");
            kisiListesi.Add(1, "Eslem Betül");
            kisiListesi.Add(2, "Leyla dd");
            kisiListesi.Add(3, "as ka");
            TODO.Add(new Kart("listeleme", "Kodların Backend ve Frontend kısmının tamamlanması", "Samet Akca", Kart.Buyuluk.XL));
            INPROGRESS.Add(new Kart("Kodların yazılması", "Kodların Backend ve Frontend kısmına destek olmak", "Eslem Beyül", Kart.Buyuluk.L));
            DONE.Add(new Kart("Tasarımların hazırlanması", "Sitede kullanılacak logonun hazırlanması", "Leyla dağ", Kart.Buyuluk.M));
        }
